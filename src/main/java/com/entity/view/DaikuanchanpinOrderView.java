...
public class DaikuanchanpinOrderView extends DaikuanchanpinOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 申请状态的值
		*/
		private String daikuanchanpinOrderYesnoValue;
	...
	public DaikuanchanpinOrderView() {

	}

	public DaikuanchanpinOrderView(DaikuanchanpinOrderEntity daikuanchanpinOrderEntity) {
		try {
			BeanUtils.copyProperties(this, daikuanchanpinOrderEntity);
			...
			* 获取： 申请状态的值
			*/
			public String getDaikuanchanpinOrderYesnoValue() {
				return daikuanchanpinOrderYesnoValue;
			}
			/**
			* 设置： 申请状态的值
			*/
			public void setDaikuanchanpinOrderYesnoValue(String daikuanchanpinOrderYesnoValue) {
				this.daikuanchanpinOrderYesnoValue = daikuanchanpinOrderYesnoValue;
			}
